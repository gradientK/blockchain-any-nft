  ...
  return (
    <div className="instructions-container">
      ...
      <div className="instruction-step">
        ...
        <img src={require("../images/instructions/1login.jpg")} alt="Login to MetaMask" className="img-login" />
      </div>

      <div className="instruction-step">
        <h3>Step 2 - Dropbox</h3>
        <p>1. Upload your future NFT's image to Dropbox</p>
        <img src={require("../images/instructions/2upload.jpg")} alt="Upload to Dropbox" className="img-upload" />
        
        <p>2. Select your image, click "Share", and click "Copy link"</p>
        <img src={require("../images/instructions/3share.jpg")} alt="Dropbox click Share" className="img-share" />
        
        <p>3. Ensure your image is shareable to "Anyone with link"</p>
        <img src={require("../images/instructions/4anyonewithlink.jpg")} alt="Dropbox is shareable" className="img-anyone-with-link" />
      </div>
      ...
      <div className="instruction-step">
        ...
        <img src={require("../images/instructions/6approve.jpg")} alt="Click Confirm" className="img-approve" />
      </div>
